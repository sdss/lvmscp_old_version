...
async def status(command: Command):
    ...
    for spectro in spectro_list:
        ...
        if wago_power_status_cmd.status.did_fail:
            ...
            spec_dict[spectro].shutter_power_status = replies[-2].body[spectro]["shutter_power"]
            spec_dict[spectro].hartmann_left_power_status = replies[-2].body[spectro]["hartmann_left_power"]
            spec_dict[spectro].hartmann_right_power_status = replies[-2].body[spectro]["hartmann_right_power"]
        ...
        if hartmann_status_cmd.status.did_fail:
            ...
            spec_dict[spectro].hartmann_left_status = replies[-2].body[spectro]["hartmann_left"]
            spec_dict[spectro].hartmann_right_status = replies[-2].body[spectro]["hartmann_right"]
        ...
        if transducer_status_cmd.status.did_fail:
            ...
            spec_dict[spectro].r1_pressure = replies[-2].body[spectro]["r1_pressure"]
            spec_dict[spectro].b1_pressure = replies[-2].body[spectro]["b1_pressure"]
            spec_dict[spectro].z1_pressure = replies[-2].body[spectro]["z1_pressure"]
            spec_dict[spectro].r1_temperature = replies[-2].body[spectro]["r1_temperature"]
            spec_dict[spectro].b1_temperature = replies[-2].body[spectro]["b1_temperature"]
            spec_dict[spectro].z1_temperature = replies[-2].body[spectro]["z1_temperature"]
    ...
    command.info(
        ...
        "HARTMANN":{"sp1": {
            "hartmann_left_power_status": spec_dict["sp1"].hartmann_left_power_status,
            "hartmann_right_power_status": spec_dict["sp1"].hartmann_right_power_status,            
            "hartmann_left_status": spec_dict["sp1"].hartmann_left_status,
            "hartmann_right_status": spec_dict["sp1"].hartmann_right_status,            
        }
        },
        "IEB_HUMIDITY":{"sp1": {"rhtRH1": spec_dict["sp1"].rhtRH1, "rhtRH2": spec_dict["sp1"].rhtRH2, "rhtRH3": spec_dict["sp1"].rhtRH3}},
        "IEB_TEMPERATURE":{"sp1": {
        ...
        "TRANSDUCER_PRES":{"sp1": {"r1": spec_dict["sp1"].r1_pressure, "b1": spec_dict["sp1"].b1_pressure, "z1": spec_dict["sp1"].z1_pressure}},
